...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}
    >
      <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border hover scale:105'
      ...
      <motion.h1 className='text-4x1 max-w-[300px] sm:text-6x1 sm:max-w-[590px] mx-auto mt-10 text-center'
      initial= {{opacity:0}}
      animate= {{opacity:1}}
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-pink-700 w-auto mt-8 px-12 py-2.5 flex items-center gap-2 roundede'
